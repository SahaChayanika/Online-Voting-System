...
int *z;
 z = &UNIVERSAL;
     ...
     while(temp!=NULL)
     {
         if((strcmp(temp->aadhar,"10001")==0&& strcmp(temp->name,"TANMOY DAS")==0 &&strcmp(temp->birth_date,"17-02-2004")==0) ||
         (strcmp(temp->aadhar,"10002")==0&& strcmp(temp->name,"SUPRIYA DEBNATH")==0 &&strcmp(temp->birth_date,"18-02-2004")==0)||
         (strcmp(temp->aadhar,"10003")==0&& strcmp(temp->name,"PRERANA BHATTACHARJE")==0 &&strcmp(temp->birth_date,"19-02-2004")==0)||
         (strcmp(temp->aadhar,"10004")==0&& strcmp(temp->name,"RAHUL PAUL")==0 &&strcmp(temp->birth_date,"20-02-2004")==0)||
